...
var knife,fruit ,monster,fruitGroup,monsterGroup, score,r,randomFruit, position,reset;
var knifeImage , fruit1, fruit2 ,fruit3,fruit4, monsterImage, gameOverImage,youWinPic,heart1,heart2,heart3,heart4,heart5,resetP;
var gameOverSound ,knifeSwoosh,youWin,die,bgm;
...
function preload(){
  ...
  youWinPic = loadImage("You Win.png");
  resetP = loadImage ("restart.png");
  ...
  text("Lifes : "+ lifes,400,50);
     ...
     else
    {
      ...
      if(monsterGroup.isTouching(knife)||lifes===0){
        ...
        reset = createSprite (300,390);
        reset.addImage(resetP);
